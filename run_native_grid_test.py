...
param.reference_data_path = os.path.expanduser('~/Documents/ACME_simulations/E3SM_v2/native_grid_data/')
...
param.ref_grid_file = os.path.expanduser('~/Documents/ACME_simulations/E3SM_v2/native_grid_data/ne120pg2.nc')
