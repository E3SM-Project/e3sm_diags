...
class AreaMeanTimeSeriesParser(CoreParser):
    def __init__(self, *args, **kwargs):
        # FIXME: B026 Star-arg unpacking after a keyword argument is strongly
        # discouraged
        super().__init__(parameter_cls=AreaMeanTimeSeriesParameter, *args, **kwargs)  # type: ignore # noqa: B026
