...
# from e3sm_diags.driver.utils.dataset_xr import _get_derived_vars_map
    ...
    for region in regions:
        ...
        for season in seasons:
            ...
            for var in variables:
                ...
                test = test_data.get_time_series_dataset(var)

                test = test.temporal.climatology(var, "month")
                # using climo_xr.climo is slower
                # test = utils.climo_xr.climo(test, var, freq = "ANNUALCYCLE")
                ...
                if "armdiags" in ref_name:
                    ...
                    if hasattr(ref[target_var], "standard_name"):
                        ref[target_var].long_name = ref[target_var].standard_name
                    ref[target_var].name = var
                else:
                    ref_data = Dataset(parameter, data_type="ref")
                    ref = ref_data.get_time_series_dataset(var)

                    ref = ref.temporal.climatology(var, "month")
