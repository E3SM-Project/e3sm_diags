...
def run_diag(parameter: CoreParameter) -> CoreParameter:
    """Get metrics for the polar diagnostic set.
...
def _run_diags_2d(
    ...
    for region in regions:
        # NOTE: Here below is from the original that was NOT in lat_lon_driver:
        ...
        ### NOTE: Here below is copied from lat_lon_driver.py
