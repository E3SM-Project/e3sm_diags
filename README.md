...
|--- | ---------------- | --- | --- |
| Wavenumber frequency analysis (tropical_subseasonal)        | The wavenumber frequency analysis (Wheeler-Kiladis Diagram) for Tropical subseasonal analysis                                                                                                            | Jim Benedict, Brian Medeiros, Jill Zhang                                                                                                                          | 2.11.0            |
