...
3. ``wget`` the following script.
    ...
    ::
        ...
        wget https://raw.githubusercontent.com/E3SM-Project/acme_diags/master/acme_diags/container/e3sm_diags_container.py
...
`here <https://github.com/E3SM-Project/acme_diags/blob/master/acme_diags/driver/default_diags/lat_lon_model_vs_obs.cfg>`_
