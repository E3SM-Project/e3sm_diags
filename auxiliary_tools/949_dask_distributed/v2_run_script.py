""""
Source: /lcrc/group/e3sm/public_html/diagnostic_output/ac.forsyth2/zppy_weekly_comprehensive_v2_www/zppy_main_branch_test_20260130/v2.LR.historical_0201/e3sm_diags/atm_monthly_180x360_aave/model_vs_obs_1982-1983/prov/e3sm.py

Webpage: https://web.lcrc.anl.gov/public/e3sm/diagnostic_output/ac.forsyth2/zppy_weekly_comprehensive_v2_www/zppy_main_branch_test_20260130/v2.LR.historical_0201/e3sm_diags/atm_monthly_180x360_aave/model_vs_obs_1982-1983/prov/e3sm.py

Diffs: https://github.com/E3SM-Project/zppy/pull/651#issuecomment-2628445196
 /lcrc/group/e3sm/public_html/diagnostic_output/ac.forsyth2/zppy_weekly_comprehensive_v2_www/zppy_main_branch_test_20260130/v2.LR.historical_0201/image_check_failures_comprehensive_v2/e3sm_diags/atm_monthly_180x360_aave/model_vs_obs_1982-1983
...
test_ts = '/lcrc/group/e3sm/ac.forsyth2/zppy_weekly_comprehensive_v2_output/zppy_main_branch_test_20260130/v2.LR.historical_0201/post/atm/180x360_aave/ts/monthly/2yr'
start_yr = int('1982')
end_yr = int('1983')
...
param.test_data_path = "/lcrc/group/e3sm/ac.forsyth2/zppy_weekly_comprehensive_v2_output/zppy_main_branch_test_20260130/v2.LR.historical_0201/post/atm/180x360_aave/clim/2yr"
...
trop_param.test_data_path = '/lcrc/group/e3sm/ac.forsyth2/zppy_weekly_comprehensive_v2_output/zppy_main_branch_test_20260130/v2.LR.historical_0201/post/atm/180x360_aave/ts/daily/2yr'
...
streamflow_param.test_data_path = '/lcrc/group/e3sm/ac.forsyth2/zppy_weekly_comprehensive_v2_output/zppy_main_branch_test_20260130/v2.LR.historical_0201/post/rof/native/ts/monthly/2yr'
...
tc_param.test_data_path = "/lcrc/group/e3sm/ac.forsyth2/zppy_weekly_comprehensive_v2_output/zppy_main_branch_test_20260130/v2.LR.historical_0201/post/atm/tc-analysis_1982_1983"
...
# Run
cfg_path = "auxiliary_tools/949_dask_distributed/v2_run.cfg"
...
if __name__ == "__main__":
  ...
  params[0].results_dir = "/lcrc/group/e3sm/public_html/cdat-migration-fy24/26-02-26-949-dask-dist"
  ...
  # Processes scheduler
  params[0].results_dir = "/lcrc/group/e3sm/public_html/cdat-migration-fy24/26-02-26-949-dask-processes"
  ...
  # Serial execution
  params[0].results_dir = "/lcrc/group/e3sm/public_html/cdat-migration-fy24/26-02-16-949-dask-serial"
