...
set -e
source "${HOME}/miniforge3/etc/profile.d/conda.sh"; conda activate ed_main_py314_xr2025120
set +e
...
results_dir=/lcrc/group/e3sm/public_html/ac.tvo/ed_main_py314_xr2025120/${tag}_${Y1}-${Y2}
