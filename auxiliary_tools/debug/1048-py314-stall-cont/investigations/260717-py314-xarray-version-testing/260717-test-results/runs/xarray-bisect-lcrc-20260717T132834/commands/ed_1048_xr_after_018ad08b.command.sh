...
readonly ENV_NAME="ed_1048_xr_after_018ad08b"
...
readonly RUN_LOG="/home/ac.tvo/E3SM-Project/e3sm_diags/auxiliary_tools/debug/1048-py314-stall-cont/test-scripts/runs/xarray-bisect-lcrc-20260717T132834/logs/ed_1048_xr_after_018ad08b.run.log"
readonly STATUS_FILE="/home/ac.tvo/E3SM-Project/e3sm_diags/auxiliary_tools/debug/1048-py314-stall-cont/test-scripts/runs/xarray-bisect-lcrc-20260717T132834/status/ed_1048_xr_after_018ad08b.env_status"
readonly RUN_TIMEOUT="60m"
readonly REPRO_RUNS="3"
readonly XARRAY_COMMIT_SHA="018ad08b12e8471b8bcc0135ce59b227f50da54b"
readonly XARRAY_COMMIT_SUBJECT="fix: CombinedLock.locked() now correctly calls lock.locked() method (Fixes #10843) (#11022)"
...
set +u
conda activate "ed_1048_xr_after_018ad08b"
set -u
cd "${REPO_ROOT}"
