...
set -e
source "${HOME}/miniforge3/etc/profile.d/conda.sh"; conda activate ed_1048_xr_2026070_py3143
set +e
...
results_dir=/lcrc/group/e3sm/public_html/ac.tvo/ed_1048_xr_2026070_py3143/climo-lock-workaround-enabled/${tag}_${Y1}-${Y2}
