...
set -e
source "${HOME}/miniforge3/etc/profile.d/conda.sh"; conda activate ed_1048_xr_2026070_py31312
set +e

# Make sure UVCDAT doesn't prompt us about anonymous logging
export UVCDAT_ANONYMOUS_LOG=False
export E3SM_DIAGS_DISABLE_CLIMO_LOCK_WORKAROUND=0
...
results_dir=/lcrc/group/e3sm/public_html/ac.tvo/ed_1048_xr_2026070_py31312/climo-lock-workaround-enabled/${tag}_${Y1}-${Y2}
