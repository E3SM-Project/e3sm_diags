...
readonly ENV_NAME="ed_1048_xr_2025120"
...
readonly RUN_LOG="/home/ac.tvo/E3SM-Project/e3sm_diags/auxiliary_tools/debug/1048-py314-stall-cont/test-scripts/runs/xarray-bisect-lcrc-20260717T132834/logs/ed_1048_xr_2025120.run.log"
readonly STATUS_FILE="/home/ac.tvo/E3SM-Project/e3sm_diags/auxiliary_tools/debug/1048-py314-stall-cont/test-scripts/runs/xarray-bisect-lcrc-20260717T132834/status/ed_1048_xr_2025120.env_status"
readonly RUN_TIMEOUT="60m"
readonly REPRO_RUNS="3"
readonly XARRAY_COMMIT_SHA="N/A (conda xarray=2025.12.0)"
readonly XARRAY_COMMIT_SUBJECT="Conda package from dev_latest.yml with xarray=2025.12.0"
...
set +u
conda activate "ed_1048_xr_2025120"
set -u
cd "${REPO_ROOT}"
