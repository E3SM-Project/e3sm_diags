...
param.results_dir = "/lcrc/group/e3sm/public_html/cdat-migration-fy24/25-02-19-branch-940-xesmf-diffs-mask-fix-sst-rmse"
...
# Run
cfg_path = "auxiliary_tools/cdat_regression_testing/940-xesmf-diffs/rmse-diffs/run.cfg"
