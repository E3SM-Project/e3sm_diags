...
param.results_dir = "/lcrc/group/e3sm/public_html/cdat-migration-fy24/25-02-14-branch-930-polar-after"
...
# Run
cfg_path = "auxiliary_tools/cdat_regression_testing/939-model-obs-plots/fix-polar-plots/v2_run.cfg"
