...
param.results_dir = os.path.join(prefix, "655-zonal-mean-2d-model-vs-model")

# Below are more optional arguments.

# What plotsets to run the diags on.
# If not defined, then all available sets are used.
param.sets_to_run = ["zonal_mean_2d"]
...
CFG_PATH = (
    ...
    "cdat_regression_testing/655-zonal-mean-2d/655.cfg"
)
