...
region_name = {'sgp': 'Southern Great Plains', 'nsa': 'North Slope Alaska', 'twpc1': 'Manus', 'twpc2': 'Nauru', 'twpc3': 'Darwin'}
    ...
    for diags_set in param_dict.keys():
        ...
        if diags_set == 'annual_cycle':
            ...
            for param in valid_parameters:
                ...
                viewer.add_row('{} at {} ({})'.format(param.variables[0], region_name[param.regions[0]], param.regions[0])) 
                viewer.add_col('Annual cycles of ' + param.var_name)
                image_relative_path = os.path.join(relative_path, '{}.{}'.format(param.output_file,ext))
