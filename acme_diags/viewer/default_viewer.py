        ...
        for row_name in row_info[set_name][group]:
            ...
            for col_season in viewer.page.columns[1:]:
                if col_season not in row_info[set_name][group][row_name]:
                    ...
                    metadata = row_info[set_name][group][row_name][col_season]['metadata']
                    ...
                    viewer.add_col(fnm + '.' + ext, is_file=True, title=col_season,
                        other_files=formatted_files, meta=metadata)
